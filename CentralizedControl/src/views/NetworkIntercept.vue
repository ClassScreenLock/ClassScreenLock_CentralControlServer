        ...
        <div class="config-section">
          ...
          <div class="form-grid">
            <div class="form-group">
              <label>
                启用网络拦截
                <CustomSwitch v-model="config.enabled" :disabled="!networkPermissions.enableGlobal" />
              </label>
            </div>
          </div>
          <div class="tip-box">
        ...
        <div class="config-section">
          ...
          <div class="rules-editor">
            <div class="rules-header">
              <span>拦截域名列表</span>
              <button class="button-primary" @click="addDomainRule" :disabled="!networkPermissions.manageDomains">添加域名</button>
            </div>
              ...
              <div v-for="(rule, index) in config.domainRules" :key="index" class="rule-item">
                <div class="rule-content">
                  <div class="form-grid">
                    <div class="form-group">
                      ...
                      <input 
                        ...
                        :disabled="!networkPermissions.manageDomains"
                      >
                    </div>
                    <div class="form-group">
                      <label>描述</label>
                  ...
                  <div class="form-group">
                    <label>
                      启用此规则
                      <CustomSwitch v-model="rule.isEnabled" :disabled="!networkPermissions.manageDomains" />
                    </label>
                  </div>
                </div>
                <button class="remove-btn" @click="removeDomainRule(index)" :disabled="!networkPermissions.manageDomains">删除</button>
              </div>
...
const networkPermissions = computed(() => {
  ...
  const actionPerms = permissions?.[role]?.actionPermissions?.network
  if (!actionPerms) {
    return {
      enableGlobal: false,
      manageDomains: false
  ...
  return {
    enableGlobal: actionPerms.enableGlobal ?? false,
    manageDomains: actionPerms.manageDomains ?? false
  }
})
